...
<script type="text/javascript" >
	...
	<img src="../images/member/img_i_pin_05.gif" alt="우리 한국석유공사는 별도의 회원가입 절차가 없습니다. 게시글 작성 등 홈페이지 이용은 i-pin 인증을 이용하여 주시기 바랍니다. I-PIN은 개인정보 유출방지를 위한 주민등록번호를 대신하는 인터넷상의 개인식별번호를 의미합니다. 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제 23조의 2(주민등록번호외의 회원가입 방법)에 따라 홈페이지 게시판에 글을 게시할땐 반드시 공공아이핀(I-PIN) 인증을 받으셔야 합니다. 공공아이핀(I-PIN)이 없으신 분들은 등록 후 사용하여 주시기 바랍니다." /></div>
						<div class="btnCen">
						<%if(userSession != null && userSession.getUserID() != null && userSession.getUserID().length() > 0){ %>
							<a href="obmChoice.jsp"><img src="../images/member/btn_i_pin.gif" alt="공공아이핀(I-PIN) 인증" /></a>
						<%}else{ %>
							<a href="/GPIN/Sample-AuthRequest.jsp" onclick="testAuth();return false;" target="_blank" title="새창"><img src="../images/member/btn_i_pin.gif" alt="공공아이핀(I-PIN) 인증" /></a>
						<%} %>
							<a href="main.jsp" title="관리자 로그인"><img src="../images/member/btn_adminlogin.gif" alt="관리자 로그인" /></a>
						</div>
					</div>
					<!-- 회원가입 삭제[2011.07]
