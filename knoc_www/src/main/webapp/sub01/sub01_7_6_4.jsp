				...
				<div class="recruit3">					
					<div id="hit">
						<ul class="tab">
							...
							<li><a href="sub01_7_6_4.jsp"><img src="/images/info/sub01_7_6_5r.gif" alt="병역특례 전문연구요원" border="0" id="his_button5"/></a></li>
						</ul>
						<h4 class="pt20"><img src="/images/info/sub01_7_6_1ta4_1.gif" alt="병역특례 전문연구요원" /></h4>
						<div class="guide2">
							<table class="chart1" summary="병역특례 전문연구요원 채용안내 세부사항을 확인할 수 있습니다.">
								<caption>병역특례 전문연구요원 채용안내</caption>
								<col width="15%"/>
								<col width="25%"/>
								...
								<tbody>
									...
									<tr>
										...
										<td>종합면접</td>
										<td class="tdleft">지원자의 자질 및 공사 핵심가치와의 부합성 등</td>
									</tr>
								</tbody>
							</table>
