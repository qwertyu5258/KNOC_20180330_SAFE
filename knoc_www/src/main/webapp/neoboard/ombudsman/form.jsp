...
<%		
	...
	String obm_type = etcutil.strBlockSpecialTags(etcutil.checkNull(request.getParameter("obm_type")));
	pp.setPage(nowpage);
	pp.setPageSize("10");
	pp.setPageUrl("");
...
<form action="submit.jsp" method="post" name="form01" id="form01" enctype="multipart/form-data">
	...
	<input type="hidden" id="article_pwd" name="article_pwd" value="<%=session.getAttribute("virtualno") %>"/>			
