...
<input name="virtualno" type="hidden" value="<%= userSession==null ? "":userSession.getUserVirtualno()%>" />
	...
	<colgroup><col width="100px" /><col width="260px" /><col width="100px" /><col width="260px" /></colgroup>
		<tr>
			<th scope="row" class="th1"><label for="ans_email">이메일</label></th>
		...
		<tr>
			<th scope="row"  class="th1"><label for="tel">전화번호</label></th>
			<td class="td1" colspan="3"><input type="text" value="<%=phone1 %>" id="tel1" name="tel1" class="input" style="width:25px;" maxlength="3" title="지역번호"/> - <input type="text" value="<%=phone2 %>" name="tel2" class="input" style="width:25px;" maxlength="4" title="국번"/> - <input type="text" value="<%=phone3 %>" name="tel3" class="input" style="width:25px;" maxlength="4" title="전화번호 끝자리"/></td>
		</tr>
		<tr>
			<th scope="row"  class="th1"><label for="htmlBody">답변내용</label></th>
			<td class="td1" colspan="3">
			<textarea name="HTML_BODY" cols="95" rows="15" class="area" id="htmlBody"><%=EtcUtil.checkNull(article.getAnswer()) %></textarea>
			</td>
		</tr>
		<tr>
...
%>
		...
		<tr>
			...
			<th class="th1"><label for="status">처리결과</label></th>
			<td class="td1">
