...
<% if(!"SANGDAM".equals(propBean.getBoardID()) && !"CLEAR2".equals(propBean.getBoardID()) ){ %>
		<tr>
			...
			<td class="td1" colspan="5"><label for="question">질문 <input name="contGubun" id="question" type="radio" value="질문" <% if (article.getContGubun().equals("질문")) { %>checked="checked"<% } %> /></label> <label for="notify">불편신고 <input name="contGubun" type="radio" value="불편신고" <% if (article.getContGubun().equals("불편신고")) { %>checked="checked"<% } %> /></label> <label for="praise">직원칭찬 <input name="contGubun" type="radio" value="직원칭찬" <% if (article.getContGubun().equals("직원칭찬")) { %>checked="checked"<% } %> /></label> <label for="suggest">제안 <input name="contGubun" type="radio" value="제안" <% if (article.getContGubun().equals("제안")) { %>checked="checked"<% } %> /></label> <label for="others">기타 <input name="contGubun" type="radio" value="기타" <% if (article.getContGubun().equals("기타")) { %>checked="checked"<% } %> /></label></td>
		</tr>
<%} %>
