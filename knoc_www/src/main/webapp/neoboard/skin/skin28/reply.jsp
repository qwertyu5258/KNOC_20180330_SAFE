...
<input name="virtualno" type="hidden" value="<%= userSession==null ? "":userSession.getUserVirtualno()%>" />
	...
	<colgroup><col width="110px" /><col width="590px" /></colgroup>
		...
		<tr>
			<th scope="rows" class="th1"><label for="htmlBody">내&nbsp;&nbsp;용</label></th>
			<td class="td12">
<%
...
%>
			<textarea name="HTML_BODY"  id="htmlBody" cols="95" rows="15" class="area"><%=content.toString()%></textarea>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="td1">
				<label for="open"><input type="radio" name="secret" id="open" value="0" checked />공개</label> <label for="close"><input type="radio" name="secret" id="close" value="1" /> 비공개</label>
			</td>
		</tr>
		<% } %>
