...
<td>
	...
	<td style="padding:5px;text-align:left;" class="board_titletop2"><%=StringUtil.replaceInString(article.getSubject(),"[Re]","<span class=font_12px_20_bold>[Re]</span>")%></td>
	<td width="90" align="center" bgcolor="#F1F1F1" class="board_titletop">Hit</td>
	<td width="200" style="padding:5px;text-align:left;" class="board_titletop2"><%=article.getHitcnt() %></td>
	</tr>
	<tr style="height: 30px;">
	<td width="50" align="center" bgcolor="#F1F1F1" class="board_titletop3">Write</td>
	<td style="padding:5px;text-align:left;" class="board_listbott"><%=article.getName()%></td>
	<td width="90" align="center" bgcolor="#F1F1F1" class="board_titletop3">Date</td>
	<td width="200" style="padding:5px;text-align:left;" class="board_listbott"><%=article.getRegDateString("yyyy-MM-dd")%></td>
	</tr>
	<tr style="height: 30px;">
	<td width="50" align="center" bgcolor="#F1F1F1" class="board_titletop3">File</td>
	<td colspan="3" style="padding:5px;text-align:left;" class="board_listbott">
...
<%	} %>	
	...
	<tr>
	<td style="padding:18px;text-align:left;word-break:break-all;">
<%
...
%>	
	...
	<td style="padding:5px;text-align:left;" class="board_pretitle3"><% if ( prevArticle != null) { %><a href="<%=pageBean.getPageUrl()%><%=pageBean.makeQueryString(prevArticle.getNo(),"view",true)%><%=schBean.makeQueryString("","bid=" + propBean.getBoardID()+"&amp;ses="+sessionName,false)%>"><%=prevArticle.getSubject()%></a><% } else { %>no cont<% } %></td>
	</tr>
	<tr height="30">
	<td width="100" align="center" class="board_pretitle2"><img src="../images/ico_nexttxt.gif" width="5" height="3" class="img2" /> Next</td>
	<td style="padding:5px;text-align:left;" class="board_pretitle4"><% if ( nextArticle != null) { %><a href="<%=pageBean.getPageUrl()%><%=pageBean.makeQueryString(nextArticle.getNo(),"view",true)%><%=schBean.makeQueryString("","bid=" + propBean.getBoardID()+"&amp;ses="+sessionName,false)%>"><%=nextArticle.getSubject()%></a><% } else { %>no cont<% } %></td>
	</tr>
	</table>
</td>
</tr>
