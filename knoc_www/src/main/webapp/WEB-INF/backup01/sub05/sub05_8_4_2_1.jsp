		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="locadv">
					...
					&gt; <span>어린이</span>
                    &gt; <span>석유만화방</span>
                    &gt; <span class="locanow">해피유의석유사랑</span>
				</div>
				<!--// location: end //-->
				
				<div class="pagetle">
					<h3><img src="/images/child/ttl_sub07_4_2.gif" alt="해피유의석유사랑" /></h3>
				</div>
				<!--시작-->
				<div id="substar">
					<ul class="tab">
                    <li><a href="sub05_8_4_2_1.jsp"><img src="/images/child/tab_sub07_4_2_1r.gif" alt="색칠하기"/></a></li>
					...
					<tbody>
						...
						<tr>
							<th scope="row"  class="vTop" rowspan="3">
							<div class="imgbg"><img src="/upload/neoboard/PETRO/img02_color01.jpg" alt="누비와 바다 여행 이미지" /></div></th>
							<td style="vertical-align:top"><div class="padd10">누비와 바다 여행을 떠나세요.</div></td>
						</tr>
						<tr>
							<td>우리나라 대륙붕에서 최초로 가스가 발견된 6-1광구의 돌고래 구조 이미지를 형상화 해서 태어난 누비! 이제 누비와 바다로 여행을 떠나보세요.  </td>
						</tr>
						<tr>
							<td class="textri">
								<div class="textri"><a href="/upload/neoboard/PETRO/coloring02.zip" title="누비와 바다 여행 이미지 저장하기"><img src="/images/child/btn_dataok.gif" alt="누비와 바다 여행 이미지 저장하기" /></a>&nbsp;<a href="#" title="누비와 바다 여행 이미지 인쇄하기(새창)" onclick="window.open('/upload/neoboard/PETRO/coloring_print2.html','ocookie','scrollbars=yes,menubar=no,width=632,height=600')"><img src="/images/child/btn_print.gif" alt="누비와 바다 여행 이미지 인쇄하기(새창)" /></a></div></td>
						</tr>
						</tbody>
					</table>
                </div>
