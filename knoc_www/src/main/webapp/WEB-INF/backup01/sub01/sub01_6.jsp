		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="locadv">
					...
					&gt; <span>공사소개 </span>
                    &gt; <span class="locanow">석유공사30년사</span>
				</div>
				<!--// location: end //-->
				
				<!-- [2009-09-15 수정] :: 작성자: 장정인 -->
				<div class="pagetle">
					<h3><img src="/images/info/ttl_sub01_6.gif" alt="석유공사30년사" /></h3>
				</div>
				<!--시작-->				
				<div class="introduction">
					<h4><img src="/images/info/sub01_6_ta1.gif" alt="KNOC의 어제" /></h4>
					<div class="pt20">
						...
						<ul class="history">
							<li><strong>한국석유공사의 태동</strong>
								<p>제1차 석유파동 이후 우리나라 에너지 분야에 관한 정책을 종합적이고 체계적으로 추진하기 위한 부처의
									설립이 필요하다는 의견이 각처에서 제기되었고, 이에 따라 에너지를 둘러싼 국제연건의 변화에 효율적으로
					...
					<div class="pt20">
						<div><img src="/images/info/img_sub01_6_3.gif" alt="KNOC의 내일" /></div>
						<ul class="history">
