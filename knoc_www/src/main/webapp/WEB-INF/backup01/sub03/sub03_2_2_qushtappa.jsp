			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <h4><img src="../images/business/img_ttl_sub03_2_2_qushtappa.gif" alt="이라크 - Qush Tappa" /></h4>
                   <div class="mT10"><img src="../images/business/img_sub03_2_2_krg_tappa.gif" alt="이라크 - Qush Tappa 광구도" /></div>
                    
                   <p class="rtxt">[2012년 6월말 기준]</p>
					<table class="chart2" summary="이라크 - Qush Tappa 광구 정보를 확인할 수 있습니다.">
					
					<caption>이라크 - Qush Tappa 광구 정보</caption>
					<col width="60px" />
					<col width="60px" />
					<col width="70px" />
					<col width="70px" />
                    ...
                    <p class="mT20">이라크 쿠르드 지역에 위치한 Qush Tappa 광구는, 2008년 12월 이라크 쿠르드 정부와 생산물 분배계약을 통해 광권을 취득하였고 한국 석유공사가 운영권을 가지고 있다. 2011년 8월 탐사시추 1공을 완료 하였으며 현재 시추후평가작업이 진행 중이다.</p>
                </div>
				<!--//끝-->
		  </div>
