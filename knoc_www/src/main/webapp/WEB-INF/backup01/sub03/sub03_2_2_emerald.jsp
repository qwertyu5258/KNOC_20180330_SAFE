			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <h4><img src="../images/business/img_ttl_sub03_2_2_emerald.gif" alt="미국 멕시코만 - Emerald" /></h4>
                   <div class="mT10"><img src="../images/business/img_sub03_2_2_mcxico.gif" alt="미국 멕시코만 - Emerald 광구도" /></div>
                    
                    <p class="rtxt">[2013년 3월 기준]</p>
					<table class="chart2" summary="미국 멕시코만 - Emerald 광구 정보를 확인할 수 있습니다.">
					<caption>미국 멕시코만 - Emerald 광구 정보</caption>
					<col width="60px" />
					<col width="60px" />
					<col width="70px" />
					<col width="70px" />
