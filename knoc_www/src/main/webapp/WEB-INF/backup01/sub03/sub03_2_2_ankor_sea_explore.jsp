			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <div class="mT10"><img src="../images/business/img_sub03_2_2_mcxico.gif" alt="미국 멕시코만 - Diamond 광구도" /></div>
                    
                    <p class="rtxt">[2015년 6월말 기준]</p>
					<table class="chart2" summary="미국 멕시코만 - Diamond 광구 정보를 확인할 수 있습니다.">
					<caption>미국 멕시코만 - Diamond 광구 정보</caption>
					<col width="60px" />
					<col width="60px" />
					<col width="70px" />
					<col width="70px" />
                    ...
                    <p class="mT20">2007년 한국컨소시엄(한국석유공사, 경남기업, 삼천리, 한화, SK가스)은 미 멕시코만 중부 Lease Sale 205에 Murphy사(운영권자)와 공동입찰에 참여 Diamond, Emerald, Platinum, Gold 구조에 해당하는 8개의 리스의 낙찰자로 선정 및 계약 체결하여, 2008년 Diamond 구조에 탐사시추 1공 및 2014년 Emerald 구조에 탐사시추 1공을 추진하였으나, 상업성 미달로 인해 2015년 6월 현재 종료를 추진 중에 있다.</p>
                </div>               
