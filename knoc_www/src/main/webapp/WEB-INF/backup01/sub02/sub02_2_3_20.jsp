		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="officer">
					...
					<li><a href="sub02_2_3_20.jsp"><img src="/images/business/ab_sub02_2_3_20r.gif" alt="2007년"></a></li>
					</ul>
					<p class="rtxt">(단위 : 백만원)</p>
					<!--표-->
					<table class="chart3" summary="2007년한국석유공사 주요사업별 수익을 확인할 수 있습니다.">
