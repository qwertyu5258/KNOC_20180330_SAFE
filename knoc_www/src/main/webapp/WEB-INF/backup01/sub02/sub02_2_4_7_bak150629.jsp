	...
	<div id="rightarea">
		<div id="subcnts">
			...
			<div class="locadv">
				...
				<span>열린경영</span> &gt; <span>경영공시</span> &gt; <span>인적자원현황</span> &gt; <span class="locanow">인력개발현황</span>
			</div>
			<!--// location: end //-->
			...
			<div class="officer">
				...
				<h5>자격증 보유현황(‘15년 3월말 기준)</h5>
				<!--표-->
				<table class="chart2" summary="2015년 3월까지 한국석유공사 자격증 보유현황을 박자, 기술사, 변호사, 회계사, 세무사별로 확인할 수 있습니다.">
				...
				<div class="new_officer" style="margin-top:5px ;">
					<table summary="담당부서 및 연락처 관리일">
						...
						<tbody>
							<tr>
								<td><strong>담당부서 : </strong>인재경영처 인사팀</td>
								<td><strong>연락처 : </strong>052-216-2706</td>
			...
			<div class="new_officer" style="margin-top:5px ;">
				<table summary="담당부서 및 연락처 관리일">
					...
					<tbody>
						<tr>
							<td><strong>담당부서 : </strong>인재경영처 인재육성팀</td>
							<td><strong>연락처 : </strong>052-216-2742</td>
							<td><strong>관리일 : </strong>2015-09-30</td>
						</tr>
					</tbody>
				</table>
