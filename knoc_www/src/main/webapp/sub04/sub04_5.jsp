				...
				<div class="customer">
					...
					<div class="declaration pb05">
						...
						<li><strong>유의사항</strong><br />
							<ul>
								<li>- 본 민원실은 실명을 원칙으로 하며, 석유관련 일반적인 질의 등 민원과 관련이 없는 사항은 반드시 <br />&nbsp;&nbsp;&nbsp;석유정보망<span class="pl10"><a href="http://www.petronet.co.kr/"  target="_blank" title="석유정보망 홈페이지로 이동(새창)"><span class="ce45108_b">"http://www.petronet.co.kr"</span></a>의 고객센터 등의 코너를 이용하시기 바랍니다.</span></li>
							</ul></li>
						<li><strong>연락처 : 감사실 민원담당  이정훈 과장(☎ 052-216-2164 / 팩스 052-216-5950)</strong></li>
						</ul>
					</div>
					...
					<div class="declaration pb05">
						...
						<li><strong>유의사항</strong><br />
							<ul>
								<li>- 신고는 실명을 원칙으로 하며, 석유관련 일반적인 질의 등 부조리와 관련이 없는 사항은 반드시<br />&nbsp;&nbsp;&nbsp;석유정보망<span class="pl10"><a href="http://www.petronet.co.kr/"  target="_blank" title="석유정보망 홈페이지로 이동(새창)"><span class="ce45108_b">"http://www.petronet.co.kr"</span></a>의 고객센터 등의 코너를 이용하시기 바랍니다.</span></li>
							</ul></li>
						<li><strong>연락처 : 감사실 부조리 신고 담당 이문환 과장 052-216-2122 / 팩스 052-216-5950)</strong></li>
						</ul>
					</div>
...
<br /><br />
					...
					<div class="customer2">
						...
						<tr>
							<td style="padding-left:50px;text-align:center;"><a href="/sub04/sub04_5_list.jsp?page=1&amp;mode=write&amp;bid=MINWON&amp;rtype=MW"><img src="../images/customer/btn_03.gif" alt="민원(부조리) 신고" /></a>&nbsp;<a href="#contents" onclick="popup_passwd(); return false;" title="새창"><img src="../images/customer/btn_04.gif" alt="처리결과조회" /></a></td>
			...
			<div class="new_officer">
				...
				<tbody>
				<tr>
					<td class="write_day"><strong>작성기준일 : </strong>2016-09-20</td>
					<td class="contact_team"><strong>담당부서 : </strong>감사실 비축감사팀</td>
					<td class="contact_user"><strong>담당자 : </strong>이정훈</td>
					<td class="contact_tel"><strong>연락처 : </strong>052-216-2164</td>
				</tr>
				</tbody>
				</table>
			</div>
			...
			<div class="new_officer mT10">
				...
				<tr>
					...
					<td class="contact_user"><strong>담당자 : </strong>이문환</td>
					<td class="contact_tel"><strong>연락처 : </strong>052-216-2122</td>
				</tr>
				</tbody>
				</table>
			</div>
