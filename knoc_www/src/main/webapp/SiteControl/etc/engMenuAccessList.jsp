...
<script language="javascript">
	...
	function goExcel(rank_year, rank_month, sdate, edate, period){
		location.href="engMenuAccessExcelList.jsp?rank_year="+rank_year+"&rank_month="+rank_month+"&sdate="+sdate+"&edate="+edate+"&period="+period;
	}
</script>
...
<td valign=top>
	...
	<td valign="top">
		...
		<td valign="top">			
			...
			<form method="post" id="fm01" name="fm01" action="engMenuAccessList.jsp">
						...
						<td class=descBorder_r width="240px;">
							<span>
								<select name="page_lang" id="page_lang" onchange="searchMenuLang();">
									...
									<option value="ENG" selected="selected">영문</option>
								</select>
							</span>						
		...
		%>
			...
			<%
				...
				String delMcode = "";
				while(iter2.hasNext()){		
					EngMenuBean mb = (EngMenuBean)iter2.next();
			...
			<a href="engMenuAccessList.jsp?depth1=01">Who we are</a> | <a href="engMenuAccessList.jsp?depth1=02">Corporate Responsibility</a>
			 | <a href="engMenuAccessList.jsp?depth1=03">Operations</a>
			 | <a href="engMenuAccessList.jsp?depth1=04">Investor Relations</a>
			 | <a href="engMenuAccessList.jsp?depth1=05">Service</a>
			 | <a href="engMenuAccessList.jsp?depth1=06">E&P Technology Institute</a>
			 </td>
			</tr>        
			</table>				
<!-- ROW 시작 -->	
