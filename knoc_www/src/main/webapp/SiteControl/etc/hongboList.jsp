...
<td valign=top>
	...
	<td valign="top">
		...
		<td valign="top">			
			...
			<input type=button value=' 홍보사진등록  ' class=button onClick="jsWrite();">
			</td>
			</tr>        
			</table>	
...
%>																																	
			...
			<td align=center><input type=button value=' 수정' class=button onClick="edit('<%=hb.getNo() %>');"> <input type=button value=' 삭제 ' class=button onClick="jsDelete('<%=hb.getNo() %>');"></td>
			</tr>
<%				
			seq--;
		}
