...
<form name=schform method=post action="recruitList.jsp">				
			...
			검색구분 :
		      ...
		      <option <% if (!key_gbn.equals("") && key_gbn.equals("company")) { %>selected<% } %> value="company">소속기관</option>
		      </select>
...
<input type="hidden" name="no" value="">	
			...
			<td align=center width="80">소속기관</td>
			<td align=center width="80">일반전화</td>
			<td align=center width="80">휴대전화</td>
			<td align=center width="80">참여날짜</td>
			<td align=center width="60">인원</td>
			<td align=center width="100">등록일</td>
			<td align=center width="120">관리</td>
			</tr>    
<%  if(count==0) { %>				
			<tr height="25"  bgcolor="#FFFFFF">
			<td align=center colspan=10>등록된 자료가 없습니다.</td>
			</tr>
<% 
	} else {
...
%>																																	
			...
			<td align=center><input type=button value=' 수정' class=button onClick="edit('<%=rb.getNo() %>');"> <input type=button value=' 삭제 ' class=button onClick="jsDelete('<%=rb.getNo() %>');"></td>
			</tr>
<%				
			seq--;
		}
