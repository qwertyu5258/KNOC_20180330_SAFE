...
<script language="javascript">
	...
	function goEditOkFn(){ 
		...
		if(confirm((fm.gov_public_file_seq.value == ""?"등록":"수정")+" 하시겠습니까?")){
			fm.action="board_05_edit_file_ok.jsp";
			fm.submit();
		}
	}
	...
	function goDeleteFn(){
		...
		if(confirm("삭제 하시겠습니까?")){
			fm.action="board_05_filedelete.jsp";
			fm.submit();
		}
	}
	...
	function goCancelFn(){
		var fm = document.boardform01;
		location.href="/SiteControl/neoboard/board_05_filelist.jsp?gpk=" + fm.gpk.value + "&page=" + fm.page.value + "&search_type=" + fm.search_type.value + "&search_keyword=" + fm.search_keyword.value + "&gov_public_nid=" + fm.gov_public_nid.value;
	}
								...
								<td valign="top">
									...
									<form method="post" name="boardform01" enctype="multipart/form-data">
										...
										<table width="100%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="B5B5B5">
											...
											<tr height="25">
												<td align="left" bgcolor="#e7e7e7" style="padding-left:10px;" >파일이름</td>
												<td colspan="3" align="left" bgcolor="#FFFFFF" style="padding-left:10;">
													<p style="color:#a7a7a7; margin:0;">공표할 파일이름을 입력해주세요.</p>
