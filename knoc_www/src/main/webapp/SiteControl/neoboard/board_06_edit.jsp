...
<script language="javascript">
	...
	function goEditOkFn(){ 
		...
		if(confirm((fm.gov_public_nid.value == ""?"등록":"수정")+" 하시겠습니까?")){
			fm.action="board_06_edit_ok.jsp";
			fm.submit();
		}
	}
	...
	function goCancelFn(){
		var fm = document.boardform01;
		location.href="/SiteControl/neoboard/board_06.jsp?gpk=" + fm.gpk.value + "&page=" + fm.page.value + "&search_type=" + fm.search_type.value + "&search_keyword=" + fm.search_keyword.value;
	}
								...
								<td valign="top">
									...
									<form method="post" name="boardform01" enctype="multipart/form-data">
										...
										<table width="100%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="B5B5B5">
											<tr height="25">
												<td width="120" align="left" bgcolor="#e7e7e7">구분</td>
											...
											<tr height="25">
												<td align="left" bgcolor="#e7e7e7">공표목록</td>
											    <td colspan="3" align="left" bgcolor="#FFFFFF" style="padding-left:10;">
											...
											<tr height="25">
												<td align="left" bgcolor="#e7e7e7">공표매체</td>
												<td colspan="3" align="left" bgcolor="#FFFFFF" style="padding-left:10;">
													<p style="color:#a7a7a7; margin:0;">※ http://www.knoc.co.kr 형태의 전체 주소를 입력해 주세요.</p>
