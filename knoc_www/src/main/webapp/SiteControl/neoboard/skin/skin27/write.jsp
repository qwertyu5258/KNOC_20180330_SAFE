...
<input type="hidden" name="thumbType" value="new2" />
	...
	<colgroup><col width="110px" /><col width="590px" /></colgroup>
		...
		<tr>
			...
			<td class="td1"><input type="text" value="" id="subjtxt2" name="HTML_BODY" class="input" style="width:570px;" maxlength="70" /></td>
		</tr>
		...
		<tr>
			...
			<td class="td1">
				<div class="filedv1">
				<input type="file" name="file2" id="file2" value="" class="input" style="width:330px;" title="첨부파일2" /><span class="f_pad"> <%=propBean.getMaxUploadLimit("MB")%></span><br />
				</div>
			</td>
		</tr>
