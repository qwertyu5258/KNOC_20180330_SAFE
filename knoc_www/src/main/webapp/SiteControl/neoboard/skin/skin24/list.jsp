...
<div id="boardsec">
	...
	<colgroup><col width="55px" /><col width="415px" /><col width="100px" /><col width="130px" /></colgroup>
		<tr>
			<th>번호</th>
			<th>제목</th>
			<th>표지이미지</th>
...
%>	
		<tr>
			...
			%>
				<img src="/upload/neoboard/<%=propBean.getBoardID()%>/T<%=af.getNewFileName()%>" alt="이미지" width="25" height="30" /></div>
			<% 
						 }
					} %>  
			<% } else { %>
				<img src="/images/board/ebook_img.gif" alt="이미지" />
			<% } %>
			</td>
