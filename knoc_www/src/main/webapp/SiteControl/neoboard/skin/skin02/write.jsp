...
<% if(!"SANGDAM".equals(propBean.getBoardID()) && !"CLEAR2".equals(propBean.getBoardID()) ){ %>
		<tr>
			...
			<td class="td1" colspan="5">질문 <input name="contGubun" type="radio" value="질문" checked="checked" /> 불편신고 <input name="contGubun" type="radio" value="불편신고" /> 직원칭찬 <input name="contGubun" type="radio" value="직원칭찬" /> 제안 <input name="contGubun" type="radio" value="제안" /> 기타 <input name="contGubun" type="radio" value="기타" /></td>
		</tr>
<%} %>
