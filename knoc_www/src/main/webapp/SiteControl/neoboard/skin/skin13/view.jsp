...
<% if (article.getUrl() != null && !article.getUrl().equals("")) { %>
			...
			<%	/*
				    ...
				    codebase="ftp://ftp.cjdream.net/pub/multimedia/player/mediaplayer/mpie4ful.exe"
					width="320" height="288" id="MediaPlayer"
				  ...
				  <param name="Filename" value="">   value=article.getUrl()
				  ...
				  <embed type="application/x-mplayer2" pluginspage="ftp://ftp.cjdream.net/pub/multimedia/player/mediaplayer/mpie4ful.exe" height="288" src="http://www.knoc.co.kr/kor/board/gallery/20080926.wmv" align="middle" showpositioncontrols="0" showcontrols="0" autosize="0" autostart="1" showdisplay="0" showstatusbar="0" showtracker="0" appbgcolor="black" width="320" height="288"></embed>
				  </object>
				  */   %>
				  
				  <iframe width="385" height="321" src="<%=article.getUrl() %>" frameborder="0" allowfullscreen></iframe>
