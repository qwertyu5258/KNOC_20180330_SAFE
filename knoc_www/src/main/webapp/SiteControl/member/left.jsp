...
<td bgcolor="EAEAEC" align="center" valign="top">
	...
	<td bgcolor="#FFFFFF" align="center" valign=top>
		...
		<tr>
		<td style="padding:0 0 0 8"><img src="../images/admin_left_title.GIF" width="9" height="9"><b> 회원관리</b></td>
		</tr>
		</table>
		<table width="158" border="0" cellpadding="0" cellspacing="0" bgcolor="F4F3F3">
		<tr>
		<td height="28" style="padding:0 0 0 15"><img src="../images/admin_left_02.GIF" width="3" height="3"><a href="memberList.jsp" onfocus="this.blur();"><% if (gNavMenuDepth1.equals("01")) { %><span class="style7"><% } else { %><span><% } %> 회원리스트</span></a></td>
		</tr>
		<tr>
		...
		<table width="158" border="0" cellpadding="0" cellspacing="0" bgcolor="F4F3F3">
		<tr>
		<td height="28" style="padding:0 0 0 15"><img src="../images/admin_left_02.GIF" width="3" height="3"><a href="memberStatus.jsp" onfocus="this.blur();"><% if (gNavMenuDepth1.equals("02")) { %><span class="style7"><% } else { %><span><% } %> 회원현황</span></a></td>
		</tr>
		<tr>
		<td height="1" bgcolor="#FFFFFF"></td>
		</tr>
