	      ...
	      <tr>
	        ...
	        <table class="con_wrap" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr>
	            ...
	            <neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="PICTURES" adminURL="" sessionName="USERSESSION"/>
	...
	<div class="new_officer">
		...
		<tbody>
		    <tr>
		        ...
		        <td class="contact_tel"><strong>Contacts : </strong>+82)52-216-2622</td>																        
		    </tr>
		</tbody>
		</table>
	</div><!-- new_officer end -->  
