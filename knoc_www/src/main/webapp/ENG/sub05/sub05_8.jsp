	    ...
	    <td align="center" valign="top"><table width="1000" height="124" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <table class="con_wrap" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr>
	            <td height="34" align="right"><img src="../images/ico_home.gif" alt="home" /> &gt; Service &gt; <span class="loca_text"> News latter</span></td>
	          </tr>
	           <tr>
	            <td height="24" align="left" background="../images/sub06/title_line_bg.gif"><img src="../images/sub05/ttl_sub05_8.gif" alt="News latter" width="84" height="24" /></td>
	          </tr>
	          <tr>
	            <td align="center" valign="top">
					<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="ENNL" adminURL="" sessionName="USERSESSION"/>
				</td>
	          </tr>
	          <tr>
	                  	<td>
