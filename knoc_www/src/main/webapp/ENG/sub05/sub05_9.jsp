	      ...
	      <tr>
	        ...
	        <table class="con_wrap" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr>
	           ...
	           <tr>
	            <td height="24" align="left" background="../images/sub06/title_line_bg.gif"><img src="../images/sub05/ttl_sub05_9_1.gif" width="45" height="24" alt="Poster" /></td>
	          </tr>
	          <tr>
	            <td align="center" valign="top">
					<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="ENPST" adminURL="" sessionName="USERSESSION"/>
				</td>
	          </tr>
	          <tr>
	              	<td>
