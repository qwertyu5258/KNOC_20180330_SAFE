	    ...
	    <td align="center" valign="top"><table width="1000" height="124" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <table class="con_wrap" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr>
	            <td height="34" align="right"><p><img src="../images/ico_home.gif" alt="home" /> &gt;Service &gt;<span class="loca_text"> PR Video</span></td>
	          </tr>
	           <tr>
	            <td height="24" align="left" background="../images/sub06/title_line_bg.gif"><img src="../images/sub05/ttl_sub05_1_2.gif" width="65" height="24" alt="KNOC PR Room" /></td>
	          </tr>
	          <tr>
	            <td align="center" valign="top" background="0">
				<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="ENGMOVIE" adminURL="" sessionName="USERSESSION"/>
				</td>
	          </tr>
	          <tr>
	          	<td height="40">&nbsp;</td>
	...
	<div class="new_officer">
		...
		<tbody>
		    <tr>
		        ...
		        <td class="contact_tel"><strong>Contacts : </strong>+82)52-216-2226</td>																        
		    </tr>
		</tbody>
		</table>
	</div><!-- new_officer end -->  
