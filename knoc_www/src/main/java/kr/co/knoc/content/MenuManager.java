...
public class MenuManager {
	public boolean insertMenu(MenuBean mb){
		...
		try {
			...
			String sql = "select max(no) from MENU";
	...
	public String getMCodeMax(String mcode, int depth){
		...
		try {
			...
			String sql = "SELECT * FROM ( select RPAD(substr(mcode,1,"+len+"),8,'0') from MENU";
	...
	public int getListNumMax(String mcode, String depth){
		...
		try {
			...
			int len = mcode.length() + 2;
			String sql = "select max(listnum" + depth + ") from MENU";
			if (mcode != null && !mcode.equals("")) {
	...
	public int getListNum(String mcode, String depth){
		...
		try {
			...
			int len = mcode.length() + 2;
			String sql = "select distinct listnum" + depth + " from MENU";
			if (mcode != null && !mcode.equals("")) {
				sql += " where substr(mcode,1,"+mcode.length()+") = '" + mcode + "'";
			}
	...
	public ArrayList<MenuBean> getMenuList(String mcode, String status) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
	 ...
	 * @return
	 */
	public ArrayList<MenuBean> getMenuAccessList(String mcode) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
 		...
 		query.append(" FROM MENU T1 LEFT OUTER JOIN MENU_ACCESS_COUNT T2 ON(T1.MCODE = T2.MCODE AND T2.PAGE_LANG = 'KOR') ");
	 ...
	 * @return
	 */
	public ArrayList<MenuBean> getMenuAccessRankList(String rank_year, String rank_month, String sdate, String edate, String period) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
        ...
        query.append("      WHERE PAGE_LANG = 'KOR'");
        ...
        query.append(")A ");
        query.append("INNER JOIN MENU B ON(B.MCODE = A.MCODE)");
        query.append("ORDER BY ACC_COUNT DESC");
	...
	public ArrayList<MenuBean> getMenu1List(String mcode) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
	...
	public ArrayList<MenuBean> getMenu2List(String mcode) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
	...
	public ArrayList<MenuBean> getMenu3List(String mcode) {
    	Connection con = null;
 		ResultSet rs = null;
 		PreparedStatement prestmt = null;
 		ArrayList<MenuBean> result = new ArrayList<MenuBean>();
	...
	public MenuBean getMenu(int no){
		Connection con = null;
		PreparedStatement prestmt = null;
		ResultSet rs = null;
		...
		try {
			con = DBUtil.getConnection();
			String sqlstr = "select mcode, name, url, status, listnum1, listnum2, listnum3 from MENU where no = ?";
	...
	public boolean updateMenu(MenuBean mb){
		...
		try {
			...
			String sql = "update MENU set name=?, url=?, status=? where no=?";
	...
	public boolean deleteMenu(String mcode){
		...
		try {
			...
			String sql = "delete from MENU where substr(mcode,1,"+mcode.length()+") = ?";
	...
	public static String getMenuName(String mcode) {
        ...
        try{
        	...
        	String sql = "select name from MENU where mcode = ?";
        	prestmt = con.prepareStatement(sql);
			...
			if (!mcode.substring(4,6).equals("00")) {
				sql = "select name from MENU where mcode = ?";
	        	prestmt = con.prepareStatement(sql);
	...
	public static String getMenuName2(String mcode) {
    	StringBuffer strSel = new StringBuffer();
	...
	public boolean updateListnum(int no, int listnum, int listnum2, String mcode, String gubun){
		...
		try {
			...
			if (gubun.equals("UP")) {
				sql = "update MENU set listnum1 = listnum1 + 1 where substr(mcode,1,2) = ? and ( listnum1 >= ? and listnum1 < ? )";				
			} else {
				sql = "update MENU set listnum1 = listnum1 - 1 where substr(mcode,1,2) = ? and ( listnum1 <= ? and listnum1 > ? )";
			}
			...
			sql = "update MENU set listnum1 = ? where substr(mcode,1,4) = ?";
	...
	public boolean updateListnum2(int no, int listnum, int listnum2, String mcode, String gubun){
		...
		try {
			...
			if (gubun.equals("UP")) {
				sql = "update MENU set listnum2 = listnum2 + 1 where substr(mcode,1,4) = ? and ( listnum2 >= ? and listnum2 < ? )";				
			} else {
				sql = "update MENU set listnum2 = listnum2 - 1 where substr(mcode,1,4) = ? and ( listnum2 <= ? and listnum2 > ? )";				   
			}
			...
			sql = "update MENU set listnum2 = ? where substr(mcode,1,6) = ?";
	...
	public boolean updateListnum3(int no, int listnum, int listnum2, String mcode, String gubun){
		...
		try {
			...
			if (gubun.equals("UP")) {
				sql = "update MENU set listnum3 = listnum3 + 1 where substr(mcode,1,6) = ? and ( listnum3 >= ? and listnum3 < ? )";					   			
			} else {
				sql = "update MENU set listnum3 = listnum3 - 1 where substr(mcode,1,6) = ? and ( listnum3 <= ? and listnum3 > ? )";
			}
			prestmt = con.prepareStatement(sql);
			...
			sql = "update MENU set listnum3 = ? where mcode = ?";
