...
public class PagerTag extends TagSupport{
	...
	public int doEndTag() throws JspException {
		 ...
		 * Getting PageBean
		 */	
		PageProperty pagebean = (PageProperty)pageContext.getAttribute(pageName,PageContext.REQUEST_SCOPE);
		...
		PageAnchor prevPageAnchor = new PageAnchor();
		PageAnchor prevBlockAnchor = new PageAnchor();
		PageAnchor nextPageAnchor = new PageAnchor();
		PageAnchor nextBlockAnchor = new PageAnchor();
		Vector pagesAnchor = new Vector(pageSize);
		PageAnchor firstPageAnchor = new PageAnchor();
		PageAnchor lastPageAnchor = new PageAnchor();
