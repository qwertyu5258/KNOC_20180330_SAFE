	...
	<div id="contents">
		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<!--// location: start //-->
				<div class="locadv">
					<a href="/"><img src="/images/common/loca_home.gif" alt="한국석유공사 메인페이지로 이동" /></a> &gt; <span>열린경영</span> &gt; <span>경영공시</span> &gt; <span>일반현황</span> &gt; <span class="locanow">사규</span>
				</div>
				<!--// location: end //-->
				...
				<!--시작-->
				<div class="status">
					<h4><img src="/images/management/sub02_2_1_8_ta1.gif" alt="사규"/></h4>				
				</div> <neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="CORPRULE" adminURL="" sessionName="USERSESSION"/>
