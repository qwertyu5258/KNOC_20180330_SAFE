		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="locadv">
					...
					&gt; <span>사이버홍보실</span>
					&gt; <span>홍보 간행물</span>
					&gt; <span class="locanow">브로슈어</span>
				</div>
				<!--// location: end //-->
				
				<div class="pagetle">
					<h3 class="tleimg"><img src="/images/information/ttl_sub11_5_2.gif" alt="브로슈어" /></h3>
				</div>
				<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="BROCH" adminURL="" sessionName="USERSESSION"/>
