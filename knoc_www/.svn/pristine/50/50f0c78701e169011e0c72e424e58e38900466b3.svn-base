...
<script type="text/javascript"> 
	...
	<% } %>
		...
		if(f.url.value == "") {
			alert("e-book URL을 입력해 주시기 바랍니다.");
			f.url.focus(); 
			f.url.select();
			return;
		} 
...
<input type="hidden" name="thumbType" value="new2" />	
	...
	<colgroup><col width="110px" /><col width="590px" /></colgroup>
		...
		<tr>
			<th class="th1"><label for="subjtxt">e-book URL</label></th>
			<td class="td1">
...
%>		
		<tr>
			<th class="th1"><label for="fileadd">이미지 업로드</label></th>
			<td class="td1">
				<div class="filedv1">						
<%	 	
...
%>					
		...
		<tr>
			<th class="th1"><label for="fileadd">PDF파일 업로드</label></th>
			<td class="td1">
				<div class="filedv1">
<%	 	
