...
<form name="wForm" method="post" action="termWriteOk.jsp" >
<INPUT TYPE="hidden" name="page" value="<%=nowpage%>">
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">한글</td>
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="text" name="korean" value="" maxlength="200" style="width:430px" class="input"></td>
		</tr>	
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">영어</td>
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="text" name="english" value="" maxlength="200" style="width:430px" class="input"></td>
		</tr>
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">한자</td>
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="text" name="chinese" value="" maxlength="200" style="width:430px" class="input"></td>
		</tr>
		
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">내용</td>
		<td bgcolor="#FFFFFF" style="padding-left:10;"><textarea id="content" name="content" rows="5"  cols="30" style="width:400px"></textarea></td>
		</tr>	
