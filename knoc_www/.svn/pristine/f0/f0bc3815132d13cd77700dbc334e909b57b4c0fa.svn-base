...
<form name="wForm" method="post" action="popupWriteOk.jsp" enctype="multipart/form-data">
<INPUT TYPE="hidden" name="page" value="<%=nowpage%>">
		...
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="file" name="filename" value="" maxlength=200 style="width:350px" class=input> (194 * 86px 으로 맞춰주세요.)
		</td>
		</tr>				
		<tr>
