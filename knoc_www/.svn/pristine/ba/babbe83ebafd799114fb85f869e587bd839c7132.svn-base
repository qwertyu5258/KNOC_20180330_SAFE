			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <h4><img src="../images/business/img_ttl_sub03_2_2_nigeria_321.gif" alt="나이지리아321" /></h4>
                   <div class="mT10"><img src="../images/business/img_sub03_2_2_nigeria.gif" alt="나이지리아321 광구도" width="650px" /></div>
                    
                   <p class="rtxt">[2013년 3월 기준]</p>
					<table class="chart2" summary="나이지리아321 광구 정보를 확인할 수 있습니다.">
					<caption>나이지리아321 광구 정보</caption>
					<col width="60px" />
					<col width="60px" />
					<col width="70px" />
					<col width="70px" />
                    ...
                    <p class="mT20">OPL 321광구는 서아프리카 기네아만 해상에 위치하며, 수심 약 1,900~2,500m의 심해광구로, 광구 면적은 약 1,166Km2이다. 2006년 3월, 나이지리아국영석유회사(NNPC)와의 생산물분배계약 체결 이후 현재 사업 진행 중이다.</p>
