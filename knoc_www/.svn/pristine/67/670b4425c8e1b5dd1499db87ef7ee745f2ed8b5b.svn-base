...
<% 
	...
	String gNavPage = "홍보사진관리";  					// 현제 페이지 제목
	/*'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''*/
%>
<%
...
<td valign="top">
	...
	<td valign="top">
		...
		<td valign="top">
			...
			<tr>
			<td><img src="/SiteControl/images/admin_left_03.gif" width="11" height="11"> 기타 관리 > 홍보사진관리</td>
			<td width="500" align="right" style="padding-right:20;">HOME > <span class="style6"> 기타 관리 > 홍보사진관리</span></td>
			</tr>
			<tr>
...
<INPUT TYPE="hidden" name="oldFilename" value="<%=hb.getNewFilename()%>">
		...
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">사진 업로드</td>		
		...
		<div style="height:24px;">
			<a tabindex="0"><font style='font-size:8pt;color=gray'>첨부파일: <b><%=hb.getFilename()%></font></a>
			<br><input title="파일삭제" type="checkbox" name="fileupdate" id="fileupdate" value="<%=hb.getNo()%>" onclick="checkFile(this);" onkeypress="checkFile(this);">
