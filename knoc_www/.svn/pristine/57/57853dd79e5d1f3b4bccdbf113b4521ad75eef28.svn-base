...
<%
	...
	String y_2013 = (request.getServletPath().toString().indexOf("/sub02/") > -1 ?"sub02_2_6_10_3.jsp":"sub04_9_9.jsp");
...
%>
	<div class="officer" style="padding-top:20px;">
		...
		<!--표-->
		<table class="chart3" summary="한국석유공사 20015년 기관장 업무추진비 집행 내역을 확인할 수 있습니다.">
			<caption>2015년 기관장 업무추진비 집행 내역</caption>
			<col width="100px" />
			<col width="*" />
			<col width="150px" />
			<thead>
