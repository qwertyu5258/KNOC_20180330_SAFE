...
<%	
	...
	WebzineBean pb = TermMa.getWebzineBean(webjin_nid);
%>
...
<INPUT TYPE="hidden" name="webjin_nid" value="<%=webjin_nid%>">
		<tr>
		<td width="100px" height="25" bgcolor="E7E7E7" align="center">링크주소</td>
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="text" name="img_path" value="<%=pb.getImg_path() %>" maxlength=200 style="width:430px" class=input></td>
		</tr>	
		<tr>
