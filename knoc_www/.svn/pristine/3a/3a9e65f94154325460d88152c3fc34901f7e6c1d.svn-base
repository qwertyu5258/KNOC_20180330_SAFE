			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <div class="mT10"><img src="../images/business/ep_energy.gif" alt="미국 ep energy 광구도" /></div>
                    ...
                    <p class="mT20">공사는 ‘12년 5월 Apollo사 등 파트너사와 컨소시엄 구성하여 Kinder Morgan사가 인수하는 El Paso사 상류부분 자회사인 EP energy사 지분 의 14.99%를 인수하였고, 미국 육상에 다수의 유·가스전을 운영하고 있다. 또한, EP사는 '14년 1월 미국 증시에 공식 상장하였으며, 현재 일일 16천배럴(’15년 6월 공사몫 기준)을 생산하고 있다. 미국 EP Energy 사업 참여로 미국 비전통자원 핵심지역에서 상당 규모의 매장량/자원량을 확보함으로 높은 성장 포텐셜을 확보하였다.</p>
                </div>
				<!--//끝-->
		  </div>
