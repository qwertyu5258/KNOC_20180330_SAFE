		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="great">
					...
					<dd><span>- GREAT : </span><span>G</span>lobalization, <span>R</span>espect, <span>E</span>thics, <span>A</span>ction, <span>T</span>rust라는 5가지의 가치를 함축하여 표현</dd>
					<dd><span>- 3020 : </span>공사 대형화 목표달성을 위해 2012년까지 일생산량 <span>30만배럴</span>, 매장량 <span>20억배럴</span> 확보라는 계량적인 목표를 상징적으로 표현</dd>
					</dl>
				</div>
				<!--//끝-->
			</div>
