...
<%
	...
	pp.setPageSize("10");
	pp.setPageUrl("");
	ArrayList al = TermMa.getTermList2(pp.getNPage(), pp.getNPageSize());		
...
<td valign=top>
	...
	<td valign="top">
		...
		<td valign="top">			
			...
			<tr>
			<td><img src="/SiteControl/images/admin_left_03.gif" width="11" height="11"> 기타 관리 > 모바일관리</td>
			<td width="500" align="right" style="padding-right:20;">HOME > <span class="style6"> 모바일관리 > 웹진 관리</span></td>
			</tr>
			<tr>
...
%>																																	
			...
			<td align=center><a href="javascript:edit('<%= pb.getWebjin_nid() %>')"><%= pb.getAlt_name() %></a></td>	
			</tr>
<%				
