...
<div id="boardsec">
	...
	<colgroup><col width="50px" /><col width="75px" /><col width="180px" /><col width="75px" /><col width="70px" /><col width="60px" /><col width="50px" /><col width="70px" /><col width="80px" /></colgroup>
		<tr>
			<th scope="col">번호</th>
            <th scope="col">구분</th>
			<th scope="col">제목</th>
...
<% } %>			
			...
			<select id="field" name="field" title="검색조건 선택">
