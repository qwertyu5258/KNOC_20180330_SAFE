			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
                   ...
                   <h4><img src="../images/business/img_ttl_sub03_2_2_platinum.gif" alt="미국 멕시코만 - Platinum" /></h4>
                   <div class="mT10"><img src="../images/business/img_sub03_2_2_mcxico.gif" alt="미국 멕시코만 - Platinum 광구도" /></div>
                    
                   <p class="rtxt">[2013년 3월 기준]</p>
					<table class="chart2" summary="미국 멕시코만 - Platinum 광구 정보를 확인할 수 있습니다.">
					<caption>미국 멕시코만 - Platinum 광구 정보</caption>
					<col width="60px" />
					<col width="60px" />
					<col width="70px" />
					<col width="70px" />
                    ...
                    <p class="mT20">2007년 한국컨소시엄(한국석유공사, 경남기업, 삼천리, 한화, SK가스)은 미멕시코만 중부Lease Sale 205에 Murphy사(운영권자)와 공동입찰에 참여 Diamond, Emerald, Platinum, Gold 구조에 해당하는 8개의 선정 및 계약 체결하여 현재 사업 진행 중이다.</p>
