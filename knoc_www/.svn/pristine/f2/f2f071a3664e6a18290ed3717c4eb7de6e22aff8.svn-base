	...
	<div id="contents">
		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<!--// location: start //-->
				<div class="locadv">
					<a href="/"><img src="/images/common/loca_home.gif" alt="한국석유공사 메인페이지로 이동" /></a> &gt; <span>열린경영</span> &gt; <span>경영공시</span> &gt; <span>기타정보</span> &gt; <span class="locanow">특허권 보유 현황</span>
				</div>
				<!--// location: end //-->
				...
				<!-- officer -->
				<div class="officer">
					<h4><img src="/images/management/sub02_2_6_7_ta.gif" alt="특허권 보유 현황"/></h4>
					<!-- h5>석유정보 공인기관 지정</h5>
					...
					<tbody>
						...
						<tr>
							<td class="first">지하저장공동의 능동형 수벽장치</td>
							<td>지하유류저장공동 기밀성 유지를 위한 수벽시스템 운영 중 구역별 수리적안정성 만족여부에 따른 주입압 조정 기술</td>
							<td class="tdcen">특허권</td>
						</tr>
						<tr>
							<td class="first">웹 환경에서의 탄성파 탐사 정보 조회 및 제공 방법 및 시스템</td>
							<td>웹을 기반으로 탄성파 탐사자료의 조회가 원하는 자료에 대한 다운로드가 가능한 시스템 개발</td>
							<td class="tdcen">특허권</td>
						</tr>
						<tr>
							<td class="first">합성가스 제조용 개질 촉매, 이를 이용한 합성가스 제조 방법 및 합성가스 제조 반응기</td>
							<td>GTL의 구성 기술중 천연가스를 합성유 제조 중간단계인 합성가스로 제조하는 특허 기술</td>
							<td class="tdcen">특허권</td>
						</tr>
					</tbody>
					</table>
				...
				<div class="new_officer">
					...
					<caption>담당부서 및 연락처 관리일</caption>
						<tbody>
							<tr>
								<td class="write_day"><strong>작성기준일 : </strong>2016-07-26</td>
