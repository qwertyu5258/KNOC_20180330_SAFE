	    ...
	    <td align="center" valign="top"><table width="1000" height="124" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <table class="con_wrap" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr>
	            <td height="34" align="right"><p><img src="../images/ico_home.gif" alt="home" /> &gt;Service &gt;<span class="loca_text"> Poster &#13;</span></td>
	          </tr>
	           <tr>
	            <td height="24" align="left" background="../images/sub06/title_line_bg.gif"><img src="../images/sub05/ttl_sub05_10_1.gif" width="65" height="24" alt="Brochure" /></td>
	          </tr>
	          
	          <tr>
	            <td align="center" valign="top">
					<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="ENBRC" adminURL="" sessionName="USERSESSION"/>
				</td>
	          </tr>
	          <tr>
	              	<td>
