		...
		<div id="rightarea">
			<div id="subcnts">
				...
				<div class="locadv">
                    ...
                    &gt; <span>경영공시</span>
					&gt; <span>기타정보</span>
                    &gt; <span class="locanow">임원추천위원회 회의록</span>
				</div>
				<!--// location: end //-->
				...
				<!--시작-->
				<div id="substar">
                	<h4><img src="/images/management/sub02_2_1_12_ta1.gif" alt="임원추천위원회 회의록"/></h4>
				</div>
				<neo:neoboardFacade parentUri="<%=request.getServletPath()%>" mode="list" bid="IMWON" adminURL="" sessionName="USERSESSION"/>
