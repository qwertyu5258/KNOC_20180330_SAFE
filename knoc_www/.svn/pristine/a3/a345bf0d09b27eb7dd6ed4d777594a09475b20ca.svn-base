...
<input name="secret" type="hidden" value="1" />
	...
	<colgroup><col width="110px" /><col width="130px" /><col width="110px" /><col width="130px" /><col width="110px" /><col width="130px" /></colgroup>
		...
		<tr>
			...
			<td class="td1"><input type="text" value="" id="tel1" name="tel1" class="input" style="width:25px;" maxlength="3" title="지역번호"/> - <input type="text" value="" name="tel2" class="input" style="width:25px;" maxlength="4" title="국번"/> - <input type="text" value="" name="tel3" class="input" style="width:25px;" maxlength="4" title="전화번호 끝자리"/></td>
		...
		<tr>
			...
			<td class="td1" colspan="5"><input type="text" value="" id="zipno1" name="zipno1" class="input" style="width:60px;" maxlength="3" readonly onclick="openZipcode();"  title="우편번호 앞자리"/> <a href="#" onclick="openZipcode();"><img src="<%=skinRoot %>/images/btn_se.gif" align="top" alt="주소찾기" /></a></td>
		</tr>
		<tr>
	         <td class="td1" colspan="5"><input type="text" value="" id="addr1" name="addr1" maxlength="200" class="input" style="width:580px;" readonly onclick="openZipcode();" title="기본 주소"/></td>
		</tr>
	    <tr>
	...
	<div class="boardbtm">
		<div class="btnsec">
			...
			<a href="/sub04/sub04_6.jsp"><img src="<%=skinRoot %>/images/btn_cancel.gif" alt="취소" /></a>
		</div>
	</div>
</div>
