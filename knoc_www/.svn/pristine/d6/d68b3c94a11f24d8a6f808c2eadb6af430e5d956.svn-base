...
<input name="id" type="hidden" value="<%= userSession==null ? "":userSession.getUserID()%>" />
	...
	<colgroup><col width="110px" /><col width="590px" /></colgroup>
		...
		<% } %>
        <tr>
			<th class="th1"><label for="subjtxt">담당부서</label></th>
			<td class="td1"><input type="text" id="name" name="name" class="input" style="width:130px;" value="" maxlength="32" /></td>
		</tr>
		<tr>
