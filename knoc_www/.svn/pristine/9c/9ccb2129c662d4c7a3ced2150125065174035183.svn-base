...
<td valign="top">
	...
	<td valign="top">
		...
		<td valign="top">
			...
			<tr>
			<td><img src="../images/admin_left_03.gif" width="11" height="11"> 기타 관리 > 팝업존관리</td>
...
<INPUT TYPE="hidden" name="oldFilename" value="<%=pb.getNewFilename()%>">
		...
		<td bgcolor="#FFFFFF" style="padding-left:10;"><input type="radio" name="visibility" value="Y" <% if (etcutil.checkNull(pb.getVisibility()).equals("Y")) { %>checked<% } %>>표출<input type="radio" name="visibility" value="N" <% if (pb.getVisibility().equals("N")) { %>checked<% } %>>표출안함</td>
		</tr>
		<tr>
