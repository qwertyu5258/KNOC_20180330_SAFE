...
<% 
	...
	HashMap hash = sinmungoUserManager.getUserInfo(1);
	...
	<input type="hidden" name="type" value="<%=etcutil.strBlockSpecialTags(etcutil.checkNull(request.getParameter("type"))) %>">
				...
				<table cellspacing="0" cellpadding="0" class="viewtype" summary="GREAT WAY 게시판의 상세정보를 입력합니다.">
					...
					<tr>
						...
						<td class="cnts1"><input type="text" value="<%=hash.get("EMAIL") %>" id="email" name="email" maxlength="200" class="input" style="width:80%;" onKeypress="onlyNumber();"></td>
					</tr>
					<tr>
