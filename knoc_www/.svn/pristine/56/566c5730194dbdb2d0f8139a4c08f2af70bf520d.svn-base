...
public class StringFormat {
	...
	*/
	...
	/**
	 * 숫자를 각종 형태로 Formatting 한다.
	 * @param num Formatting 하고자 하는 숫자
	 * @param numFormatPattern 패턴
	 * @return Formatted String 
	 */
	public static String numberFormat(Number num, String numFormatPattern) {
	    String fString;
	    synchronized(numberFormat) {
			numberFormat.applyPattern(numFormatPattern);
			fString = numberFormat.format(num);
		}
	    return fString;
	}
	public static String numberFormat(int num,String numFormatPattern) {
	    return numberFormat(new Integer(num),numFormatPattern);
	}
	public static String numberFormat(long num,String numFormatPattern) {
	    return numberFormat(new Long(num),numFormatPattern);
	}
	public static String numberFormat(double num,String numFormatPattern) {
	    return numberFormat(new Double(num),numFormatPattern);
	}
	public static String numberFormat(short num,String numFormatPattern) {
	    return numberFormat(new Short(num),numFormatPattern);
	}
