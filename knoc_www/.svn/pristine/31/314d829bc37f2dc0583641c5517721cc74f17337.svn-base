			...
			<div id="subcnts">
			  ...
			  <!--// location: start //-->
				...
				<div class="business2">
					...
					<div><img src="../images/business/img_sub03_2_2_north_wales_01.gif" alt="영국캡틴 광구도" /></div>
					...
					<h4><strong>영국 캡틴 광구</strong></h4>
                       <p>영국 캡틴 유전은 애버딘(Aberdeen) 북동쪽 약 145km(킬로미터) 지점에 있는 영국 북해 대륙붕 내 13/22a광구에 위치해 있으며, 수심 약 104m(미터), 면적 약 56.8㎢(평방킬로미터)이다.<br />캡틴 유전은 Chevron사와 The Korea Captain Company Limited (KCCL)이 공동으로 참여하고 있다.<br />한국석유공사와 SK에너지의 합작법인인 The Korea Captain Company Limited (KCCL)은 1996년에 Chevron-Texaco사로부터 캡틴유전 지분 15%(퍼센트)를 취득하였다.</p>
						<p>
						2009년 12월, 공사는 SK에너지가 보유한 KCCL 지분을 인수하여 KCCL의 단독주주가 되었다.<br />
                        캡틴 유전 운영권자는 Chevron Upstream Europe이며, 1997년 3월 6일 원유생산을 개시하여 2011년 1월말 기준 누적생산량이 244백만배럴에 달하며,37개 생산정에서 일일생산량 약 37천배럴의 원유를 생산하고 있다.<br />
                         주요 시설은 생산 플랫폼 2기(WPP(Wellhead Protector Platform), BLP(Bridge Linked Platform)), 파이프라인, FPSO(Floating Production, Storage and Offloading) 및 수송선이 있다.</p>
